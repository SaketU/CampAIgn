...
1. **Create a LinkedIn App**: Follow the guide in [linkedin-setup.md](./linkedin-setup.md)
...
For detailed setup instructions, see [linkedin-setup.md](./linkedin-setup.md).
